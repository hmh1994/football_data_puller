...
class MatchAwayTeamGoalAssociation(AbstractMatchGoalAssociation):
    """
    Concrete association class for away team goal events.
    ...
    def __init__(
        ...
        """
        Initialize a new away team goal association.
