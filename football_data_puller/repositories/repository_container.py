...
from football_data_puller.repositories.players.player_repository import PlayerRepository
from football_data_puller.repositories.seasons.season_repository import SeasonRepository
from football_data_puller.repositories.standings.standing_repository import (
    StandingRepository,
)
from football_data_puller.repositories.teams.team_repository import TeamRepository


class RepositoryContainer(DeclarativeContainer):
    """
    Repository container for the application.
